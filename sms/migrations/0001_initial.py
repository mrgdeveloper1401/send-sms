    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', django_jalali.db.models.jDateTimeField(auto_now_add=True, null=True)),
                ('message_body', models.TextField(verbose_name='متن پیام')),
                ('foreignkey_mobile_phone', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='foreignkey_mobile_phone', to='sms.phonebookmodel', verbose_name='انتخاب شماره موبایل')),
